...
download_launches = BashOperator(
    ...
    bash_command="curl -o /home/gardenjun/바탕화면/STUDY/airflow/Airflow/launches.json -L 'https://ll.thespacedevs.com/2.0.0/launch/upcoming'", # 실행할 배시 커맨드
...
def _get_pictures(): # 호출할 파이썬 함수
    # 디렉터리 확인
    pathlib.Path("/home/gardenjun/바탕화면/STUDY/airflow/Airflow/images").mkdir(parents=True, exist_ok=True) # 디렉터리가 존재하지 않으면 생성
    # Download all pictures in launches.json
    with open("/home/gardenjun/바탕화면/STUDY/airflow/Airflow/launches.json") as f: # 이전 단계의 테스크 결과 확인
        ...
        for image_url in image_urls:
            try:
                ...
                target_file=f"/home/gardenjun/바탕화면/STUDY/airflow/Airflow/images/{image_filename}"
